...
import com.example.emotiondetection.utils.AudioRecorder;
import com.example.emotiondetection.utils.FileUtil;
...
public class FirstFragment extends Fragment {
    ...
    private Button start,pause,cameraButton,play, stop, type, pause2, next, previous, loop, switch_btn;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        clickShow = view.findViewById(R.id.clickme);
...
//                    Log.d("MyTag","First Here");
//                } else {
//                    Log.d("MyTag","Then Here");
//                    dispatchTakePictureIntent();
//                }
                Log.d("MyTag","After Opening Activity");
            }
        });
