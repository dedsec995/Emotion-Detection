...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class PlayServicesLibraryAccessors extends SubDependencyFactory {
        ...
        private final PlayServicesVisionLibraryAccessors laccForPlayServicesVisionLibraryAccessors = new PlayServicesVisionLibraryAccessors(owner);
        ...
        /**
         * Returns the group of libraries at play.services.vision
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public PlayServicesVisionLibraryAccessors getVision() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForPlayServicesVisionLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class PlayServicesVisionLibraryAccessors extends SubDependencyFactory {

        public PlayServicesVisionLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for common (com.google.android.gms:play-services-vision-common)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
            ...
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("play.services.vision.common");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: playServicesVisionCommon (19.1.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getPlayServicesVisionCommon() { return getVersion("playServicesVisionCommon"); }
